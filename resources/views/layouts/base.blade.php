                ...
                <div class="header-nav-section">
                    <div class="container">
                        <ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info" >
                            ...
                            <li class="menu-item" style="padding: 10px 15px;"><a href="#" class="link-term">Top rated items</a><span class="nav-label hot-label">hot</span></li>
                        </ul>
                    </div>
                </div>
...
<script src="https://cdn.tiny.cloud/1/kfzzkglk8e70ing5jl9qim4j8y7m4mrhycvifolfw3tcdocr/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
